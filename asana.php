...
class Asana {
     ...
     * @return string json
     */
    public function getTasksByProjectId($projectId, $opt_fields = ""){
    	$opt_fields = !empty($opt_fields) ? "?opt_fields={$opt_fields}" : "";
    	return $this->askAsana($this->projectsUrl . "/{$projectId}/tasks{$opt_fields}");
    }
}